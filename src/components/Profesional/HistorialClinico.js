...
const validateForm = (busqueda) =>{
    ...
    const buscarHistoria = () => {
        ...
        clienteAxios.get("http://25.0.53.159:3000/api/consultasMedicas/historiaMedica/consultar/" + busqueda)
          .then(({ data }) => {
            console.log(data);
    ...
    const handleSubmit = (e) =>{
        e.preventDefault();
            ...
            clienteAxios.defaults.headers.common['Authorization'] = `Bearer ${props.token}`;
            clienteAxios.put('http://25.0.53.159:3000/api/consultasMedicas/historiaMedica/actualizar/' + historia.fk_id_paciente , nuevoHistorial)
            .then(({data})=>{
