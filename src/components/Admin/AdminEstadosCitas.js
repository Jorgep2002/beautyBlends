...
function AdminEstados (props){
   ...
   const getCitas = ()=>{
    ...
    clienteAxios.get('http://25.0.53.159:3000/api/citas/Administador/citasProgramadas')
    .then(({data})=>{
      console.log(data)
...
useEffect(() => {
  ...
  const renderPageNumbers = pages.map(number=>{
    ...
    clienteAxios.put('http://25.0.53.159:3000/api/citas/updateStatus/'+id_cita,estadoDos)
  .then(({data})=>{
    console.log(data)
               Swal.fire({
         icon: 'success',
