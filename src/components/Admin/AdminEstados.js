...
function AdminEstados (props){
   ...
   const getCitas = ()=>{
    clienteAxios.get('/users/administrador/estadoUsuario/'+initialForm.estado)
    .then(({data})=>{
      console.log(data)
  ...
  const renderPageNumbers = pages.map(number=>{
    ...
    const activar = (id_correo) =>{
      ...
      clienteAxios.put('/users/updateStatus/'+id_correo,estadoUno)
    .then(({data})=>{
      console.log(data)
                 Swal.fire({
           icon: 'success',
    ...
    clienteAxios.put('/users/updateStatus/'+id_correo,estadoTres)
  .then(({data})=>{
    console.log(data)
               Swal.fire({
         icon: 'success',
